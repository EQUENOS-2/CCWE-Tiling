...
If you have [Python](https://www.python.org/downloads/), you can install the `litemapy` library by running `pip install litemapy` in the console. After than you'll be able to run the `.py` file directly.
...
![An isorender of CCWE](images/CCWE.png)
